      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-form-item label="检查项">
            <el-select v-model="form.check_item">
              <el-option v-for="item in check_item_arr" :key="item" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
...
import { getLanguageApi, getRecordListApi } from '@/api/pe/jobManage/timedJob'
...
export default {
  ...
  methods: {
    init() {
      Promise.all([getLanguageApi(), getRecordListApi(this.form)]).then(res => {
